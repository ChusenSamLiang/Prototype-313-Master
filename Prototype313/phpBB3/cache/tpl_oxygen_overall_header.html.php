...
<title> Prototype 313 &bull; <?php echo (isset($this->_rootref['PAGE_TITLE'])) ? $this->_rootref['PAGE_TITLE'] : ''; ?></title>
<link rel="shortcut icon" href="styles/oxygen/imageset/logo.png" />
...
// <![CDATA[
	...
	*/
	...
	function setLink(obj){
		...
		obj.href = obj.href.substring(0, idx != -1 ? idx : link.length)  + url;
	};
...
<a id="top" name="top" accesskey="t"></a>
	...
	<div class="nav">
		<ul class="bar">
			<ul class="navi">
		    <li><a href="../index.php" onmousedown="setLink(this)">Home</a></li>
		    <li><a href="../concepts.php" onmousedown="setLink(this)">OOP Concepts</a></li>
		    <li><a href="../company.php" onmousedown="setLink(this)">Incubator/Company</a></li>
		</ul>
